...
RUN install_packages \
    ...
    fonts-liberation libu2f-udev vim \
    ...
    chromium chromium-common chromium-sandbox chromium-driver
...
# google-chrome --headless --no-sandbox --disable-dev-shm-usage --window-size=1400,1400
