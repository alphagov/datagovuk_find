# Data standards
A range of standards for improving how data is used across
government.
...
Learn how to select and use open standards for information exchange,
formatting and describing information, publishing information, and more.

## [Data Standards Authority](https://www.gov.uk/government/collections/data-standards-authority)
The Data Standards Authority (DSA) works with experts across the
public sector, devolved administrations, industry and academia to
understand interoperability problems that can be tackled by adopting
...
particular the GEMINI metadata standard, apply to most cases for
geospatial data exchange and management.
