...
The AIR Information Resource (UK AIR) stores 3 types of data: 
...
This data is published by the Department for Environment, Food and Rural Affairs (DEFRA) devolved administrations under the [Open Government Licence](https://www.nationalarchives.gov.uk/doc/open-government-licence/version/2/) (OGL).
