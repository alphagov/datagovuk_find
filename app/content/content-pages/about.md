...
We’re working on some issues with the data.gov.uk directory, including navigation and data updates. Please bear with us while we get there resolved.
...
The Government Digital Service (GDS) works with other organisations within and outside government to shape the strategic direction for how data is managed, accessed and used. We work collaboratively on a range of issues with the Office for National Statistics, the Cabinet Office and the National Cyber Security Centre.
